...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Facturation.ListDevis, Facturation", ListDevis.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ListDevis.class)
			mono.android.TypeManager.Activate ("Facturation.ListDevis, Facturation", "", this, new java.lang.Object[] {  });
	}
