...
{
    [Activity(Label = "UpdateAdminInfo", Theme = "@style/AppTheme.NoActionBar")]
    public class UpdateAdminInfo : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            nom.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].NomClinet;
            Email.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Email;
            
            tel.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Telephone;
            Adresse.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Adresse;
            CodePostal.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Codepostal;
            Ville.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Ville;
            Pays.Text = affAdmin(sharedPreferences.GetString("Emailad", ""))[0].Pays;
