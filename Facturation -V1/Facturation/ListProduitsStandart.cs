...
{
    [Activity(Label = "Liste Produits/Services", Theme = "@style/AppTheme.NoActionBar")]
    public class ListProduitsStandart : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        void OnListItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            editorfacture.PutString("NomProduit", t.Nomproduit);
        ...
        private List<ProduitClass> selectionlistProduitService()
        {
            ...
            connection.Open();
            var contenu = connection.CreateCommand();
            contenu.CommandText = "SELECT idProduit, typePro,Nomproduit, Prix ,tva  from Produit";
            ...
            while (r.Read())
            {
                ...
                produit.Add(new ProduitClass(int.Parse(r[0].ToString()),r[1].ToString(),r[2].ToString(), float.Parse(r[3].ToString()),float.Parse(r[4].ToString())));
