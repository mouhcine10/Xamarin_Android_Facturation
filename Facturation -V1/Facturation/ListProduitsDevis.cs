...
namespace Facturation
{
    ...
    public class ListProduitsDevis : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        private List<ProduitClass> selectionlistProduitService()
        {
            ...
            connection.Open();
            var contenu = connection.CreateCommand();
            contenu.CommandText = "Select * from Produit";
            ...
            while (r.Read())
            {
                ...
                produit.Add(new ProduitClass(r[0].ToString(),r[1].ToString(), float.Parse(r[2].ToString())));
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                Ajouter.Click += delegate
                {
                    ...
                    Intent intent = new Intent(this, typeof(ProduitDevis));
