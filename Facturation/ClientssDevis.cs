...
{
    [Activity(Label = "Clients", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class ClientssDevis : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try {
                ...
                //var logo = FindViewById<ImageView>(Resource.Id.imageViewlogo);

                //var btnaddlogo = FindViewById<Button>(Resource.Id.buttonAddlogo);
