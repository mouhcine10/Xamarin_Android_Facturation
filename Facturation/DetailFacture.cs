...
{
    [Activity(Label = "ActivityDetail", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class DetailFacture : AppCompatActivity
    {
        ...
        {try
            ...
            idfacture = sharedPreferences.GetInt("IDfacture", 0);
                ...
                ads1 = FindViewById<AdView>(Resource.Id.adView1Detaifacture);
                ads2 = FindViewById<AdView>(Resource.Id.adView2Detaifacture);
                ...
                btnEnregister.Click += delegate
                {
                    ...
                    InsertionArticleItem(textArticle.Text, float.Parse(textprix.Text), int.Parse(textQuantite.Text), int.Parse(texttva.Text), toast, float.Parse(texttaux.Text), sharedPreferences.GetInt("IDfacture", 0));
