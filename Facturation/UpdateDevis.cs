...
{
    [Activity(Label = "UpdateDevis", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class UpdateDevis : AppCompatActivity
    {
        ...
        string ma = "";
        string toast = "";
        Java.IO.File dir = new Java.IO.File(Android.OS.Environment.ExternalStorageDirectory.AbsolutePath + "/Devis");
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                textViewCLientupdateDevis.Text = selectionclient(Devisid)[0].NomClinet.ToString();
                ...
                transfaufacture.Click += delegate
                {
                    ...
                    builder.SetTitle("Date Echéance").SetMessage("Ex: " + DateTime.Now.ToString("dd/MM/yyyy")).SetPositiveButton("Yes", (senderAlert, args) =>
                    {
                        ...
                        intentsig.PutExtra("Emailadmin", Intent.GetStringExtra("Emailadmin"));

                        StartActivity(intentsig);


                    }).SetNegativeButton("Annuler", (senderAlert, args) => { builder.Dispose(); });
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            if (id == Resource.Id.dar)
            {
                ...
                {
                    string f = "Devis"+Devisid+".pdf";
                    CreatefaileFolder(f);
                    intent.PutExtra("a", Getfile(dir.AbsolutePath,f)[0].ToString());
        ...
        void CreatefaileFolder(string filename)
        {
            ...
            if (CheckLocationPermissionwRITE())
            {
                if (CheckLocationPermission())
                {
                    ...
                    iTextSharp.text.Image pica = iTextSharp.text.Image.GetInstance(Clientsinfosdev(sharedPreferences.GetString("Emailadmin", ""))[0].Logo);
                ...
                //    type.BackgroundColor = iTextSharp.text.Color.GREEN;
                 ...
                 //   Remise.BackgroundColor = iTextSharp.text.Color.GREEN;
                    ...
                    signature.SetWidths(new float[] { 10 });
                    ...
                    pdfCellvideSignature.MinimumHeight = 10;
                    byte[] f = null;
                    ...
                    pdfCellvideSignature1.MinimumHeight = 10;
