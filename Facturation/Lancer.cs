...
{
    [Activity(Label = "QuickFact",MainLauncher=true,Icon="@drawable/Noir", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
