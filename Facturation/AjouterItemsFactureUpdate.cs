...
namespace Facturation
{
    ...
    public class AjouterItemsFactureUpdate : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                string a=Intent.GetStringExtra("Emailadmin");
                ...
                SupportActionBar.Title = "Article Facture ";
