...
{
    [Activity(Label = "Liste CLients", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class ListCLientsStandart : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        AdView ads1, ads2;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                imagelogo.SetImageBitmap(Android.Graphics.BitmapFactory.DecodeByteArray(selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].Logo, 0, selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].Logo.Length));
