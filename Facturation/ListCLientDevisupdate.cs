...
namespace Facturation.Class
{
    ...
    public class ListClientDevisupdate : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        AdView ads1, ads2;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                Ajouter.Click += delegate
                {
                    ...
                    Intent intent = new Intent(this, typeof(ClientssDevis));
