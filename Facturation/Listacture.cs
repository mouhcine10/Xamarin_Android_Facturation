...
{
    [Activity(Label = "Liste Factures", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class Listacture : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                imagelogo.SetImageBitmap(BitmapFactory.DecodeByteArray(selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].Logo, 0, selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].Logo.Length));

                EmailHeader.Text = selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].Email;

                NomEntreprise.Text = "Bonjour " + selectionInfoEntreprise(Intent.GetStringExtra("Emailadmin"))[0].NomClinet;
                ...
                Ajouter.Click += delegate
                {
                    ...
                    editorfacture.PutString("Emailadmin", ma);
                    ...
                    editorfacture.PutString("titre", "Choisir votre client ");
        ...
        void OnListItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            try
            {
                ...
                editorfacture.PutString("Entreprise", Clientsinfos(Intent.GetStringExtra("Emailadmin")));
