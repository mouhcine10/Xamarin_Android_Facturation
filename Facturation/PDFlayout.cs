...
{
    [Activity(Label = "PDF", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class PDFlayout : AppCompatActivity
    {
        AdView ads1, ads2;
        string a = "";
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            ...
            if (item.ItemId == Resource.Id.Envoyer)
            {
                ...
                try
                {
                    ...
                    //Partagefile partagefile = new Partagefile();

                    //partagefile.Partager(a);
                    //var file = Path.Combine(FileSystem.CacheDirectory, a);
