...
{
    [Activity(Label = "Liste Devis", Theme = "@style/AppTheme.NoActionBar", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class ListDevis : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        static int i = 0;
          int IDD;
        ...
        private List<Devis> selectionlistDevis()
        {
            ...
            contenu.CommandText = "SELECT Devis.idDevis, DateValidation,NomClinet, Etat ,SUM((Prixht * Qte) + ((Prixht * Qte) * (TVA / 100)) - Remise),Devise from Devis INNER JOIN commandeDevis on Devis.idDevis = commandeDevis.IdDevis INNER JOIN   Client on Devis.idclient = Client.idclient GROUP by Devis.idDevis";
        ...
        void OnListItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            editorDevis.PutString("NomClient",InfoDevis(t.Nemrodevis)[0].Clientnom);
