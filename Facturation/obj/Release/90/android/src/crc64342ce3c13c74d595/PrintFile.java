...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Facturation.Class.PrintFile, Facturation", PrintFile.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PrintFile.class)
			mono.android.TypeManager.Activate ("Facturation.Class.PrintFile, Facturation", "", this, new java.lang.Object[] {  });
	}

	public PrintFile (android.content.Context p0, java.lang.String p1)
	{
		super ();
		if (getClass () == PrintFile.class)
			mono.android.TypeManager.Activate ("Facturation.Class.PrintFile, Facturation", "Android.Content.Context, Mono.Android:System.String, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
